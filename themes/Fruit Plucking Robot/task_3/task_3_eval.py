...
def load_eval_model():
	...
	return_code, disc_handle = sim.simxLoadModel( client_id, cwd+'//resources//backend//extraResources//task3//test_dummy_task_3.ttm', 0, sim.simx_opmode_blocking) #Load the new model
	if(return_code != 0):
